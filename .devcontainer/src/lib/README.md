...
Common utilities library for devcontainer features. Provides shared bash functions for feature installation scripts.

## Example Usage

```json
"features": {
    "ghcr.io/devopsbuildingblocks/devcontainer-features/lib:0": {}
}
```
